    ...
    return (
      <div className={cn(`flex items-center gap-2`, className)}>
        ...
        >
          ...
          <span className="h-7 w-11 cursor-pointer rounded-full border-2 border-transparent bg-gray-200 outline-none ring-offset-2 ring-offset-white transition duration-200 group-data-[selected]:bg-blue-600 group-data-[focus-visible]:ring-2 group-data-[focus-visible]:ring-blue-600">
