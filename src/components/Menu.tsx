        ...
        {open && (
          <DropdownMenu.Portal forceMount>
            <DropdownMenu.Content
              align="end"
              className="dark-theme z-[9999999] mt-2 select-none rounded-xl border border-gray-700 bg-skin-primary shadow-md"
              asChild
            >
              <motion.div
                initial={"open"}
...
export const MenuItem = ({
  ...
  return (
    <DropdownMenu.Item
      ...
      className={`${cn(
        `cursor-pointer select-none rounded-md text-sm text-white outline-none focus:bg-skin-secondary focus:outline-none data-[highlighted]:bg-skin-secondary`,
        className,
      )}`}
      asChild
    >
